  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Ionicons name="business" size={60} color="#007BFF" />
        <Text style={styles.title}>App da Empresa</Text>
        <Text style={styles.subtitle}>Gerencie suas fotos e comissões.</Text>
      </View>
    </SafeAreaView>
  );
}
    ...
    (async () => {
      if (Platform.OS !== 'web') {
        ...
        if (cameraStatus.status !== 'granted' || galleryStatus.status !== 'granted') {
          alert('Desculpe, precisamos de permissão da câmera e galeria para funcionar!');
        }
      }
    })();
  }, []);
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        {/* Passamos 'navigation' para ReportScreen para o auto-refresh (descomentado acima) */}
